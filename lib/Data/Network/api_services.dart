...
import 'package:wetherapp/Data/Network/base_api_services.dart';
import 'package:wetherapp/Data/app_exceptions.dart';
...
class ApiServices extends BaseApiServices {
  ...
  Future getApi(String url) async {
    var jsonData;
    try {
      Response response = await http.get(Uri.parse(url)).timeout(const Duration(seconds: 50));
